...
export const metadata: Metadata = {
  ...
  title: {
    default: "TENGFEI BAI 白腾飞 - AI Builder",
    template: "%s | 白腾飞",
  },
  ...
  openGraph: {
    ...
    url: baseUrl,
    siteName: "白腾飞的个人博客",
    title: "TENGFEI BAI 白腾飞 - AI Builder",
    description: "AI 时代的独立开发者、产品经理，专注于 AI、机器人、空间计算、智能家居等科技领域的前沿观察和产品使用体验分享，并开发满足特定人群需求的软硬件产品。",
    images: [
      {
        url: "/og-image.png",
        width: 1200,
        height: 630,
        alt: "TENGFEI BAI 白腾飞 - AI Builder",
      },
    ],
  },
  twitter: {
